...
import static pp.spirit.util.ArrayUtil.isArraySameLength;
import static pp.spirit.util.ArrayUtil.isEmptyArray;
import static pp.spirit.util.BasicConstant.EMPTY_CLASS_ARRAY;
import static pp.spirit.util.BasicConstant.EMPTY_STRING;
import static pp.spirit.util.CollectionUtil.createHashMap;
import static pp.spirit.util.CollectionUtil.createHashSet;
